...
function normalizeName(str) {
  ...
  const GUESTS = [
    ...
    { first: "Bree", last: "", party: "Naugle", group: 1 },
    { first: "Devin (-)", last: "", party: "Johnson", group: 1 },
    { first: "Wife Devin Johnson (-)", last: "", party: "Johnson", group: 1 },
    { first: "Drew Vincent", last: "", party: "Vincent", group: 1 },
    { first: "Rich", last: "", party: "Schuck", group: 1 },
    { first: "Faye", last: "", party: "Schuck", group: 1 },
    { first: "Bernice Bienenfeld", last: "", party: "Bienenfeld", group: 1 },
    { first: "Madeleine", last: "", party: "", group: 1 },
    { first: "John", last: "", party: "", group: 1 },
    { first: "Tod Rubin?", last: "", party: "Rubin", group: 1 },
    { first: "Leslie Rubin?", last: "", party: "Rubin", group: 1 },
    { first: "Manny", last: "", party: "Medina", group: 1 },
    { first: "Sue", last: "", party: "Medina", group: 1 },
    { first: "Shari", last: "", party: "", group: 1 },
    { first: "Steve", last: "", party: "", group: 1 },
    { first: "Kim", last: "", party: "Costigan", group: 1 },
    { first: "Mike", last: "", party: "Costigan", group: 1 },
  ];
